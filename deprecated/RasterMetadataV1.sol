...
import {RasterRendererV1} from "./RasterRendererV1.sol";
...
contract RasterMetadataV1 is IMetadata, ERC165 {
        ...
        returns (string memory svg)
    {
        ...
        RasterRendererV1.SVGParams memory params = RasterRendererV1.SVGParams({
            width: width,
            height: height,
            nodes: nodes
        });
        svg = RasterRendererV1.generateSVG(params);
    }
